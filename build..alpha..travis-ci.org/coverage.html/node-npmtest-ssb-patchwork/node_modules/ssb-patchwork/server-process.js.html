...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (configOracle.hasError()) {
...
&nbsp;
  var serverOpts = configOracle.useTLS() ? <span class="branch-0 cbranch-no" title="branch not covered" >configOracle.getTLS() </span>: {}
